      ...
      <nav className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex space-x-6">
            ...
            <Link to="/analyze" className="hover:text-purple-200 transition">Analyze</Link>
            <Link to="/leaderboard" className="hover:text-purple-200 transition">Leaderboard</Link>
          </div>
